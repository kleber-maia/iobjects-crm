...
/**
 * Representa o relatório de Ranking Atendimento Usuário.
 */
public class RelatorioRankingAtendimentoUsuario extends Report {
  ...
  // nossas ações
  static public final Action ACTION               = new Action("relatorioRankingAtendimentoUsuario", "Atendimento por Usuário", "Emite o relatório de Ranking Atendimento por Usuário.", HELP, "report/relatoriorankingatendimentousuario.jsp", "CRM", "Atendimento", Action.CATEGORY_REPORT, false, true);
  ...
  /**
   * Retorna o ResultSet de Ranking Atendimento Usuário.
   ...
   * @return ResultSet Retorna o ResultSet de Ranking Atendimento Usuário.
  ...
  /**
   * Retorna o ResultSet de Usuários.
   * <b>Importante: a rotina que executar este método deve ser responsável por
   * fechar o ResultSet retornardo e o seu Statement.</b>
   * @param empresaId int Empresa ID.
   ...
   * @param dataFinal Timestamp Data Final.
   * @param consolidado NaoSim.SIM para que a análise exibida seja consolidada
   * @return ResultSet Retorna o ResultSet de Usuários.
   *                   <b>Importante: a rotina que executar este método deve ser
   *                   responsável por fechar o ResultSet retornardo e o seu
   *                   Statement.</b>
   * @throws Exception Em caso de exceção na tentativa de acesso ao banco de
